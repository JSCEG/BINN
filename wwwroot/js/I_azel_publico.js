...
// --- Control de capas ---
// --- Menú de capas tipo árbol para Geotermia y Biomasa y todos los escenarios ---
// --- Variable global para registrar los layers de shapes ---
var shapeLayers = {};
function crearLayerGeotermia(nombre, variable, pane, color) {
    mapas[0].createPane(pane);
    mapas[0].getPane(pane).style.zIndex = 400;
    return new L.geoJson(window[variable], {
        attribution: '',
        interactive: true,
        pane: pane,
        onEachFeature: function (feature, layer) {
            var popupContent = '<table>' +
                '<tr><th>Temperatura:</th><td>' + (feature.properties['TEMP'] || '') + '</td></tr>' +
                '<tr><th>Generación máxima (GWh/a):</th><td>' + (feature.properties['GEN_MAX'] || '') + '</td></tr>' +
                '</table>';
...
function crearLayerBiomasa(nombre, variable, pane, color) {
    mapas[0].createPane(pane);
    mapas[0].getPane(pane).style.zIndex = 410;
    return new L.geoJson(window[variable], {
        attribution: '',
        interactive: true,
        pane: pane,
        onEachFeature: function (feature, layer) {
            var popupContent = '<table>' +
                '<tr><th>Industria:</th><td>' + (feature.properties['INDUSTRIA'] || '') + '</td></tr>' +
                '<tr><th>Tipo:</th><td>' + (feature.properties['TIPO'] || '') + '</td></tr>' +
                '<tr><th>Proceso:</th><td>' + (feature.properties['PROCESO'] || '') + '</td></tr>' +
                '<tr><th>Generación máxima (GWh/a):</th><td>' + (feature.properties['GENE_GWha'] || '') + '</td></tr>' +
                '</table>';
            layer.bindPopup(popupContent, { maxHeight: 400 });
        },
...
setTimeout(function () {
    ...
    var geotermiaTree = {
        label: 'Geotermia',
        children: [
            { label: 'Escenario 4', layer: (function () { var l = crearLayerGeotermia('Escenario 4', 'json_GeotermicaEscenario4_0', 'pane_GeotermicaEscenario4_0', '#e67e22'); shapeLayers['Geotermia Escenario 4'] = l; return l; })() },
            { label: 'Escenario 3', layer: (function () { var l = crearLayerGeotermia('Escenario 3', 'json_GeotermicaEscenario3_1', 'pane_GeotermicaEscenario3_1', '#e67e22'); shapeLayers['Geotermia Escenario 3'] = l; return l; })() },
            { label: 'Escenario 2', layer: (function () { var l = crearLayerGeotermia('Escenario 2', 'json_GeotermicaEscenario2_2', 'pane_GeotermicaEscenario2_2', '#e67e22'); shapeLayers['Geotermia Escenario 2'] = l; return l; })() },
            { label: 'Escenario 1', layer: (function () { var l = crearLayerGeotermia('Escenario 1', 'json_GeotermicaEscenario1_3', 'pane_GeotermicaEscenario1_3', '#e67e22'); shapeLayers['Geotermia Escenario 1'] = l; return l; })() }
        ]
    };
    // Biomasa
    var biomasaTree = {
        label: 'Biomasa',
        children: [
            { label: 'Residuos forestales Escenario 3', layer: (function () { var l = crearLayerBiomasa('Residuos forestales Escenario 3', 'json_ResiduosforestalesEscenario3_4', 'pane_ResiduosforestalesEscenario3_4', '#27ae60'); shapeLayers['Residuos forestales Escenario 3'] = l; return l; })() },
            { label: 'Residuos forestales Escenario 2', layer: (function () { var l = crearLayerBiomasa('Residuos forestales Escenario 2', 'json_ResiduosforestalesEscenario2_5', 'pane_ResiduosforestalesEscenario2_5', '#27ae60'); shapeLayers['Residuos forestales Escenario 2'] = l; return l; })() },
            { label: 'Residuos forestales Escenario 1', layer: (function () { var l = crearLayerBiomasa('Residuos forestales Escenario 1', 'json_ResiduosforestalesEscenario1_6', 'pane_ResiduosforestalesEscenario1_6', '#27ae60'); shapeLayers['Residuos forestales Escenario 1'] = l; return l; })() },
            { label: 'Residuos urbanos Escenario 3', layer: (function () { var l = crearLayerBiomasa('Residuos urbanos Escenario 3', 'json_ResiduosurbanosEscenario3_7', 'pane_ResiduosurbanosEscenario3_7', '#2ecc71'); shapeLayers['Residuos urbanos Escenario 3'] = l; return l; })() },
            { label: 'Residuos urbanos Escenario 2', layer: (function () { var l = crearLayerBiomasa('Residuos urbanos Escenario 2', 'json_ResiduosurbanosEscenario2_8', 'pane_ResiduosurbanosEscenario2_8', '#2ecc71'); shapeLayers['Residuos urbanos Escenario 2'] = l; return l; })() },
            { label: 'Residuos urbanos Escenario 1', layer: (function () { var l = crearLayerBiomasa('Residuos urbanos Escenario 1', 'json_ResiduosurbanosEscenario1_9', 'pane_ResiduosurbanosEscenario1_9', '#2ecc71'); shapeLayers['Residuos urbanos Escenario 1'] = l; return l; })() },
            { label: 'Residuos pecuarios Escenario 3', layer: (function () { var l = crearLayerBiomasa('Residuos pecuarios Escenario 3', 'json_ResiduospecuariosEscenario3_10', 'pane_ResiduospecuariosEscenario3_10', '#16a085'); shapeLayers['Residuos pecuarios Escenario 3'] = l; return l; })() },
            { label: 'Residuos pecuarios Escenario 2', layer: (function () { var l = crearLayerBiomasa('Residuos pecuarios Escenario 2', 'json_ResiduospecuariosEscenario2_11', 'pane_ResiduospecuariosEscenario2_11', '#16a085'); shapeLayers['Residuos pecuarios Escenario 2'] = l; return l; })() },
            { label: 'Residuos pecuarios Escenario 1', layer: (function () { var l = crearLayerBiomasa('Residuos pecuarios Escenario 1', 'json_ResiduospecuariosEscenario1_12', 'pane_ResiduospecuariosEscenario1_12', '#16a085'); shapeLayers['Residuos pecuarios Escenario 1'] = l; return l; })() },
            { label: 'Residuos industriales Escenario 3', layer: (function () { var l = crearLayerBiomasa('Residuos industriales Escenario 3', 'json_ResiduosindustrialesEscenario3_13', 'pane_ResiduosindustrialesEscenario3_13', '#34495e'); shapeLayers['Residuos industriales Escenario 3'] = l; return l; })() },
            { label: 'Residuos industriales Escenario 2', layer: (function () { var l = crearLayerBiomasa('Residuos industriales Escenario 2', 'json_ResiduosindustrialesEscenario2_14', 'pane_ResiduosindustrialesEscenario2_14', '#34495e'); shapeLayers['Residuos industriales Escenario 2'] = l; return l; })() },
            { label: 'Residuos industriales Escenario 1', layer: (function () { var l = crearLayerBiomasa('Residuos industriales Escenario 1', 'json_ResiduosindustrialesEscenario1_15', 'pane_ResiduosindustrialesEscenario1_15', '#34495e'); shapeLayers['Residuos industriales Escenario 1'] = l; return l; })() }
        ]
    };
    // Menú tipo árbol
    var treeLayers = L.control.layers.tree(null, [geotermiaTree, biomasaTree], { collapsed: false, position: 'topright' });
    treeLayers.addTo(mapas[0]);
    // Leyendas
    // Puedes agregar leyendas personalizadas aquí usando los archivos legend del CDN
}, 1000);

// --- Lógica para mostrar solo una capa raster o un shape ---
mapas[0].on('overlayadd', function (e) {
    // Si es raster
    if (rasterBaseLayers[e.name]) {
        // Quitar todos los raster menos el seleccionado
        Object.keys(rasterBaseLayers).forEach(function (key) {
            if (key !== e.name && mapas[0].hasLayer(rasterBaseLayers[key])) {
                mapas[0].removeLayer(rasterBaseLayers[key]);
            }
        });
        // Quitar shapes
        Object.keys(shapeLayers).forEach(function (key) {
            if (shapeLayers[key] && mapas[0].hasLayer(shapeLayers[key])) {
                mapas[0].removeLayer(shapeLayers[key]);
            }
        });
    }
    // Si es shape
    if (shapeLayers[e.name]) {
        // Quitar todos los raster
        Object.keys(rasterBaseLayers).forEach(function (key) {
            if (mapas[0].hasLayer(rasterBaseLayers[key])) {
                mapas[0].removeLayer(rasterBaseLayers[key]);
            }
        });
        // Quitar el otro shape
        Object.keys(shapeLayers).forEach(function (key) {
            if (key !== e.name && shapeLayers[key] && mapas[0].hasLayer(shapeLayers[key])) {
                mapas[0].removeLayer(shapeLayers[key]);
            }
        });
    }
...
// --- Menú de capas tipo árbol para Geotermia y Biomasa ---
// Referencia: https://cdn.sassoapps.com/Geovisualizador/data/
// Cada archivo JS define una variable global con los datos (ej: json_GeotermicaEscenario4_0)

// Crear panes y estilos para cada escenario
function crearLayerGeotermia(nombre, variable, pane, color) {
    mapas[0].createPane(pane);
    mapas[0].getPane(pane).style.zIndex = 400;
    return new L.geoJson(window[variable], {
...
// Esperar a que los scripts de datos estén cargados
setTimeout(function () {
    // Geotermia
    var geotermiaTree = {
        label: 'Geotermia',
        children: [
            { label: 'Escenario 4', layer: crearLayerGeotermia('Escenario 4', 'json_GeotermicaEscenario4_0', 'pane_GeotermicaEscenario4_0', '#e67e22') },
            { label: 'Escenario 3', layer: crearLayerGeotermia('Escenario 3', 'json_GeotermicaEscenario3_1', 'pane_GeotermicaEscenario3_1', '#e67e22') },
            { label: 'Escenario 2', layer: crearLayerGeotermia('Escenario 2', 'json_GeotermicaEscenario2_2', 'pane_GeotermicaEscenario2_2', '#e67e22') },
            { label: 'Escenario 1', layer: crearLayerGeotermia('Escenario 1', 'json_GeotermicaEscenario1_3', 'pane_GeotermicaEscenario1_3', '#e67e22') }
        ]
    };
    // Biomasa
    var biomasaTree = {
        label: 'Biomasa',
        children: [
            { label: 'Residuos forestales Escenario 3', layer: crearLayerBiomasa('Residuos forestales Escenario 3', 'json_ResiduosforestalesEscenario3_4', 'pane_ResiduosforestalesEscenario3_4', '#27ae60') },
            { label: 'Residuos forestales Escenario 2', layer: crearLayerBiomasa('Residuos forestales Escenario 2', 'json_ResiduosforestalesEscenario2_5', 'pane_ResiduosforestalesEscenario2_5', '#27ae60') },
            { label: 'Residuos forestales Escenario 1', layer: crearLayerBiomasa('Residuos forestales Escenario 1', 'json_ResiduosforestalesEscenario1_6', 'pane_ResiduosforestalesEscenario1_6', '#27ae60') },
            // Agrega aquí los residuos urbanos, pecuarios, industriales...
        ]
    };
    // Menú tipo árbol
    var treeLayers = L.control.layers.tree(null, [geotermiaTree, biomasaTree], { collapsed: false, position: 'topright' });

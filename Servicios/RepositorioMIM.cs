...
{
    public interface IRepositorioMIM
    {
    ...
    public class RepositorioMIM : IRepositorioMIM
    {
        private readonly string connectionString;

        public RepositorioMIM(IConfiguration configuration)
        {
        ...
        //         var query = @"
        //     SELECT * 
        //     FROM [Reporte].[fn_PMLs_Map]('MDA', DATEADD(day, -1, GETDATE()), GETDATE())";

        //         var resultado = await connection.QueryAsync<ReporteDIario_PMLS>(query);
        //         return resultado;
        //     }
        // }
        public async Task<IEnumerable<ReporteDIario_PMLS>> EjecutarSP_GetRD_PMLS()
